...
const Attendance = () => {
  ...
  const saveAttendance = async (
    ...
    try {
      setLoading(true);
      const response = await fetch(
        "v1/dashboard/attendance/save-attendance",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          credentials: "include",
  ...
  return (
    <div className="px-3 space-y-2">
       ...
       <h2 className="text-lg mb-2">Attendance Management</h2>

      {/* Filters */}
      <div className="grid md:grid-cols-4 gap-4 bg-white p-6 rounded-xl shadow">
