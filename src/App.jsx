...
// // const Enrollment = () => <div className="text-xl">Enrollment Page</div>;
// // const CourseFeed = () => <div className="text-xl">Course Feed Page</div>;
// // const ResultFeed = () => <div className="text-xl">Result Feed Page</div>;
// // // const Attendance = () => <div className="text-xl">Attendance Page</div>;
// // // const StudentInsights = () => <div className="text-xl">Student Insight Page</div>;
// // const Admin = () => <div className="text-xl">Admin Page</div>;
...
//         <Route path="/course-feed" element={<CourseFeed />} />
//         <Route path="/result-feed" element={<ResultFeed />} />
